...
*****************************************************************************
*****************************************************************************
* MODULE :- INTELSAT                  File : INTELSAT.C
****************************************************************************/
...
#include "intelsat.h"
#include "pars_td1.h"	// import station_position structure
...
static double fdfTimeToDays(IntelsatEpochStructure *ptstTime);
static BOOLEAN fboIsLeapYear(IntelsatEpochStructure *ptstTime);
static int finDaysSinceYearStart (IntelsatEpochStructure *ptstTime);
static int finDaysFrom (IntelsatEpochStructure *ptstFirst, IntelsatEpochStructure *ptstSecond);
...
/*************************************************************************
	...
	Modifications:
			...
			6/5/94 LJS modified to use Geraldton NVRAM routines.
							...
							double *dfSatEl )
{
	...
	dfsra = (dfCe + tstStationData.height) * dfclat;
	dfsrz = (dfCe * (1 - FLATNESS)*(1 - FLATNESS) + tstStationData.height) *
		dfslat;
...
/********************************************************************
	...
	Modifications:      6/5/94 LJS Changed argument to IntelsatEpochStructure
...
double fdfDurationInDaysFrom ( IntelsatEpochStructure *ptstFirst, IntelsatEpochStructure *ptstSecond)
{
	double dfDuration = 0;
